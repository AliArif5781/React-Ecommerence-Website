...
const MenProductDetailPage = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[100vh] w-full max-w-6xl mx-auto px-4 mb-[170px] lg:mb-0">
      <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-10 w-full">
        <div className="lg:flex-1 flex justify-center lg:justify-end pt-[200px] lg:pt-0">
          <img
            src={image}
            alt={title}
